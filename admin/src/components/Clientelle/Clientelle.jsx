...
function Clientelle() {
  ...
  const getEmployeeAllData = async () => {
    try {
      setLoading(true)
      const response = await instance.get("/clientelle" , {withCredentials:true});
      console.log("response clientelle", response);
      setLoading(false)
              ...
              <form onSubmit={handleSubmit(handleAddEmployee)}>
                ...
                <div class="mb-3">
                  <label for="recipient-name" class="col-form-label">
                    <span style={{ marginRight: "458px" }}>Clientelle Image</span>
                  </label>
                  <button
