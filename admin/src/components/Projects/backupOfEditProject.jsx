...
const EditProject = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    for (let i = 0; i < propertyGalleryImages.length; i++) {
      //("propertyGalleryImages[i]%" , propertyGalleryImages[i])
    ...
    let defaultArrays = [...DefaultGallery];
                        ...
                        <>
                          <div className="mediaContainer col-md-4 col-sm-4 col-12">
                            ...
                            <div className="btnContainer col-md-12 col-12 col-sm-12 text-center">
                              ...
                              <button type="button" className="btn btn-danger" onClick={()=>handleDeleteGalleryImg()} >Delete</button>
                            </div>
                          </div>
