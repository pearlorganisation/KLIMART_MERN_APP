...
function CommonModal({getData , onUpdateData , pathUrl}) {
    console.log("pathURl" , pathUrl)
  const [updateData, setUpdateData] = useState(getData);
  ...
  useEffect(()=>{
    ...
    setImagePreview(getData?.Image[0])
  ...
  const handleUpdate = async()=>{
    try{
      ...
      console.log("props?.updateData?._id" , getData?._id)
  
      const {data} = await instance.put(`/${pathUrl}/${getData?._id}` , formData , {withCredentials:true})   
